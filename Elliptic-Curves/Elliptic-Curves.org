...
\]
A esta funcion se le conoce como la /serie de Einsenstein/ de peso $k$. De esta definición $G_k$ es claramente invariante bajo la acción $\Phi_k$, faltaría probar que $G_k$ es holomorfa en $\hd$ y acotada en el infinito.
...
\]
Definimos la /serie de Einsenstein/ normalizada como
\[
